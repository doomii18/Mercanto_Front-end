...
const fullName = computed(() => {
    ...
    return `${profile.value.first_name || ""} ${profile.value.last_name || ""}`.trim() || "Usuario";
});
...
const municipalityName = computed(() => {
    if (!profile.value || !("municipality_id" in profile.value) || !profile.value.municipality_id) {
        return "—";
    }
    const geo = getGeoManager();
    const mun = geo?.getMunicipalityById(profile.value.municipality_id || (profile.value as any).municipality_id);
    return mun ? mun.name : "—";
});
...
<template>
    <div class="profile-layout">
        ...
        <div class="dashboard-container">
            ...
            <aside class="sidebar">
                <nav class="sidebar-menu">
                    <router-link :to="{ name: 'profile' }" class="menu-item active">
            ...
            <main class="content">
                ...
                <div class="card profile-card">
                    ...
                    <div class="profile-info">
                        ...
                        <p class="description">
                            Emprendedor en busca de los mejores productos para mi negocio.
                        </p>
                ...
                <div class="stats-cards">
                    <div class="stat-card">
                        ...
                        <div class="stat-text">
                            ...
                            <h3>3</h3>
                            <a href="pedidos.html" class="stat-link">ver mis pedidos</a>
                        </div>
                    </div>
                ...
                <div class="card personal-info-card">
                    ...
                    <div class="info-grid">
                        ...
                        <div class="info-item">
                            ...
                            <span class="value">{{ (profile as any)?.phone_number || "—" }}</span>
                        </div>
                        <div class="info-item">
                            <i class="fa-solid fa-user"></i>
                        ...
                        <div class="info-item">
                            ...
                            <span class="value">{{ (profile as any)?.national_id || "—" }}</span>
                        </div>
                        <div class="info-item">
                            <i class="fa-regular fa-envelope"></i>
        ...
        <!-- ── Modal: Avatar Wizard (Choice, Camera, Upload, Adjust) ── -->
...
@media (max-width: 1024px) {
    .sidebar { width: 220px; }
    .content { margin-left: 220px; padding: 2rem 1.5rem; }
}
