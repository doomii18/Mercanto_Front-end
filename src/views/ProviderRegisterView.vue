...
const handleLocationConfirmed = (location: AddressPickerResult) => {
  businessForm.value.latitude = location.latitude;
  businessForm.value.longitude = location.longitude;
  businessForm.value.address = location.address;
  businessForm.value.municipalityId = location.municipalityId;
};
...
<template>
  <div class="provider-register-page">
    ...
    <AddressPickerModal
      ...
      :initial-lng="businessForm.longitude"
      :initial-address="businessForm.address"
