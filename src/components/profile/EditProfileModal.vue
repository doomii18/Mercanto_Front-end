...
const emit = defineEmits<{
  ...
  (e: "saved", updatedProfile: UserProfileResponse): void;
  (e: "change-photo"): void;
}>();
...
watch(
  ...
  (isOpen) => {
    if (isOpen && props.initialData) {
      const internal = props.initialData as any;
      editForm.value = {
...
const triggerChangePhoto = () => emit("change-photo");
</script>
  ...
  >
    <template #header>
      <div class="modal-nav-header">
        <button class="btn-back-nav" @click="handleClose"><i class="fa-solid fa-arrow-left"></i></button>
    ...
    <div class="edit-photo-section">
      ...
      <div class="edit-photo-info">
        ...
        <button type="button" class="btn-change-photo" @click="triggerChangePhoto">
    ...
    <form @submit.prevent="handleSave" class="edit-form-grid">
      ...
      <div class="edit-form-actions full-width">
        <button type="button" class="btn-cancel-edit" :disabled="isSaving" @click="handleClose">Cancelar</button>
        <button type="submit" class="btn-save-edit" :disabled="isSaving">
          <i :class="isSaving ? 'fa-solid fa-spinner fa-spin' : 'fa-solid fa-check'"></i>
